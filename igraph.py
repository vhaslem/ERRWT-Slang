...
with open('word_weights_top_vocab.csv', 'w', newline='', encoding='utf-8') as f:
    writer = csv.writer(f)
...
with open('slang_weights_top_vocab.csv', 'w', newline='', encoding='utf-8') as f:
    writer = csv.writer(f)
...
# Save graph
nx.write_gml(G, 'slang_network_top.gml')
